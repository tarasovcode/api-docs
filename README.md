# A-Project OpenAPI Specification
[![Build Status](https://travis-ci.org/tarasovcode/api-docs.svg?branch=master)](https://travis-ci.org/tarasovcode/api-docs)
...
6. If you did everything correct, https://tarasovcode.github.io/api-docs/ will lead to your new docs
...
- Documentation(ReDoc): https://tarasovcode.github.io/api-docs/
- SwaggerUI: https://tarasovcode.github.io/api-docs/swagger-ui/
- Look full spec:
    + JSON https://tarasovcode.github.io/api-docs/swagger.json
    + YAML https://tarasovcode.github.io/api-docs/swagger.yaml
- Preview spec version for branch `[branch]`: https://tarasovcode.github.io/api-docs/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://tarasovcode.github.io/api-docs/ with url from the message: `Server started <url>`
